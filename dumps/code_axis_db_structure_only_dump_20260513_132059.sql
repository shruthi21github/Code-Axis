...
--
-- Host: localhost    Database: code_axis_db_qa
-- ------------------------------------------------------
...
--
-- Current Database: `code_axis_db_qa`
--

CREATE DATABASE /*!32312 IF NOT EXISTS*/ `code_axis_db_qa` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
...
CREATE TABLE `attendance_events` (
  ...
  KEY `idx_attendance_events_employee_id` (`fk_employee_id`),
  KEY `idx_attendance_events_event_type_id` (`fk_attendance_event_type_id`),
  KEY `idx_attendance_events_event_at` (`event_at`),
  KEY `idx_attendance_events_employee_event_at` (`fk_employee_id`,`event_at`),
...
CREATE TABLE `notifications` (
  ...
  KEY `idx_notifications_user_read` (`fk_user_id`,`is_read`),
...
CREATE TABLE `project_members` (
  ...
  KEY `idx_project_members_employee_id` (`fk_employee_id`),
  KEY `idx_project_members_role_id` (`fk_project_member_role_id`),
  KEY `idx_project_members_project_employee` (`fk_project_id`,`fk_employee_id`),
...
CREATE TABLE `projects` (
  ...
  KEY `idx_projects_status_active` (`fk_project_status_id`,`is_active`),
  KEY `idx_projects_start_deadline` (`start_at`,`deadline_at`),
...
CREATE TABLE `task_status_history` (
  ...
  KEY `idx_task_status_history_task_changed` (`fk_task_id`,`changed_at`),
...
CREATE TABLE `tasks` (
  ...
  KEY `idx_tasks_employee_id` (`fk_employee_id`),
  ...
  KEY `idx_tasks_employee_status` (`fk_employee_id`,`fk_task_status_id`),
  KEY `idx_tasks_employee_deadline` (`fk_employee_id`,`deadline_at`),
...
CREATE TABLE `user_sessions` (
  ...
  KEY `idx_user_sessions_user_active` (`fk_user_id`,`is_active`),
...
--
-- Dumping events for database 'code_axis_db_qa'
--

--
-- Dumping routines for database 'code_axis_db_qa'
--
...
-- Dump completed on 2026-05-13 13:21:00
